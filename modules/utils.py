...
def get_attr(id, name=None, default=None) -> dict | None:
    if name is None:
        return state.getattr(id)  # type: ignore  # noqa: F821
    return (state.getattr(id) or {}).get(name, default)  # type: ignore  # noqa: F821


def set(id: str, value, **attributes):
